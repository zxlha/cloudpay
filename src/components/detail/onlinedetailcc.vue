 ...
 * @LastEditTime: 2019-11-18 11:16:05
...
<template>
    <div>
        <div class="detailt" v-for="(ksdonline,index) in allBooksswe" :key="index">
        <span class="detailcdeai" @click="btngodelist"> &lt; </span>
            <div class="detaillt">
                <img :src="ksdonline.img" alt="">
            </div>
            <div class="detailct">
                <p>{{ksdonline.name}}</p>
            </div>
