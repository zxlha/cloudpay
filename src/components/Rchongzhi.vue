 ...
 * @LastEditTime: 2019-11-16 10:51:17
 * @Description: +
 -->
<template>
    <div class="Rfangshibox">
        ...
        <!-- <router-link to="/Jrecord"> -->
            <input type="button" class="Ranniu" value="充值" @click="ceshi">
        <!-- </router-link> -->
    </div>
</template>
...
export default {
    ...
    methods:{
        ceshi(){
            ...
            fetch('/api/card/charge?number='+str1+'&si='+str2+'&paypass='+this.vmodelmima+'&balance='+this.jine,{
                method:"POST"
            })
